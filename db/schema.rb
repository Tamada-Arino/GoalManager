...
ActiveRecord::Schema[7.1].define(version: 2024_08_01_053919) do
  ...
  create_table "reports", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["small_goal_id"], name: "index_reports_on_small_goal_id"
  end
  ...
  add_foreign_key "reports", "goals"
  add_foreign_key "reports", "small_goals"
